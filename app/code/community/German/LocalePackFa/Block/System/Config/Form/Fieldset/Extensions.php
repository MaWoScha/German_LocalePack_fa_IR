 ...
 */
class German_LocalePackFa_Block_System_Config_Form_Fieldset_Extensions
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= "<h3 style='margin-top:20px; margin-bottom:10xp;'>".$helper->__("Specific market adjustment for")." ".$helper->__("Iranian shops")."</h3>";
        $html .= "<dl>";
        $html .= "<dt>".$helper->__("Currently not available")."</dt>";
        $html .= "<dd>".$helper->__("Preconfigured for the Iranian market")."</dd>";
        $html .= "</dl>";
